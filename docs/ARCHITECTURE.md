...
Ordinary external policies are larger than the local Qwythos policy: Grok hard context 400,000 and 32,768 output floor; GLM and Gemini 512,000 with 16,384 floors; MiniMax 180,000 with a 2,048 OpenAI-compatible ceiling/floor exception; Qwythos remains 8,192 context and 4,096 output without the cloud floor. The T1 GLM preset is separate at 128,000 context / 16,384 output. Its schema-4 cost envelopes and worker count are exact manifest data rather than product-wide constants.
